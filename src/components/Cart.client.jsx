  ...
  return (
    <footer className="bottom-0 sticky">
      <div className="relative h-60 bg-white p-7 border-t-2 border-black">
        ...
        <CartCheckoutButton className="w-full border-4 border-white font-mono text-white font-bold drop-shadow-lg active:drop-shadow-none text-center px-5 py-3 bg-secondary hover:bg-opacity-75 active:bg-opacity-50 disabled:cursor-wait disabled:opacity-60">
          Checkout
        </CartCheckoutButton>
      </div>
    </footer>
